  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      technologies: ["React", "TypeScript", "Next.js", "Tailwind CSS", "GraphQL", "Jest", "Cypress", "Docker"],
      achievements: [
    ...
    },
    {
      ...
      technologies: ["React", "Vue.js", "JavaScript", "SASS", "Node.js", "MongoDB", "Redux", "Webpack"],
      achievements: [
    ...
    },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript", "React", "MySQL", "PHP", "Bootstrap", "jQuery"],
      achievements: [
        "Successfully completed 25+ website projects",
        ...
        "Earned promotion to Frontend Developer within 10 months"
      ]
    }
  ];
    ...
    <section id="experience" className={`py-20 px-4 sm:px-6 lg:px-8 ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            My journey in software development, building innovative solutions and leading teams to success.
          </motion.p>
        </motion.div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      ...
                      <div className="mt-2 md:mt-0 space-y-1">
                        <div className="flex items-center space-x-2">
                          <Calendar className={`${isDark ? 'text-gray-400' : 'text-gray-500'}`} size={16} />
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      {experience.technologies.length > 4 && (
                        <span className={`text-xs px-3 py-1 rounded-full ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-gray-200 text-gray-600'} font-medium`}>
                  ...
                  <motion.div
                    ...
                    className={`ml-4 p-2 rounded-full ${isDark ? 'bg-gray-700' : 'bg-gray-100'}`}
                  >
                    <ChevronDown className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`} size={20} />
                  </motion.div>
                </div>
              </div>
