...
//               <motion.a
//                 href="https://github.com/gaurav091100"
//                 target="_blank"
...
//               </motion.a>
//               <motion.a
//                 href="https://www.linkedin.com/in/gaurav-s-307578330"
//                 target="_blank"
//                 whileHover={{ scale: 1.1 }}
//                 whileTap={{ scale: 0.9 }}
//                 className={`p-4 rounded-xl transition-colors duration-200 ${
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={formik.handleSubmit}>
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 px-6 rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all disabled:opacity-50"
                >
                  {isSubmitting ? "Sending..." : "Send Message"}
                </motion.button>
              </form>
